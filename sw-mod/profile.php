                    ...
                    <form id="update-profile">
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-control" id="name" name="employees_name" value="' . $row_user['employees_name'] . '" required readonly>
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                    ...
                    <form id="update-password">
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input type="email" class="form-control" name="employees_email" value="' . $row_user['employees_email'] . '" readonly>
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
